...
export const CommentSection = ({ postId }: Props) => {
	...
	// Derive a valid author name for both GitHub and Google logins (fall back to email)
	...
	/* Build a tree of comments with nested replies */
			...
			{user && authorName ? (
				<form onSubmit={handleSubmit} className='mb-4'>
					<textarea
						...
						rows={3}
					/>
					<button type='submit' className='mt-2 bg-purple-500 text-white px-4 py-2 rounded cursor-pointer'>
